...
public abstract class AbstractThreadBalancerShare implements ThreadBalancer {
    ...
    public void configure(String name, int threadCountMin, int threadCountMax, long threadKeepAliveMillis, long schedulerSleepMillis) {
